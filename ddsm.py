...
Modified for DDSM data by Yair Schiff
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 ddsm.py train --dataset=/path/to/coco/ --model=coco

    # Train a new model starting from ImageNet weights
    python3 ddsm.py train --dataset=/path/to/coco/ --model=imagenet

    # Continue training a model that you had trained earlier
    python3 ddsm.py train --dataset=/path/to/coco/ --model=/path/to/weights.h5
...
class DDSMConfig(Config):
    ...
    # TODO: figure out how many images we want per gpu
    IMAGES_PER_GPU = 16
    ...
    # TODO: Might have more classes if we use Bi-RADS (1-5) lexicon
    NUM_CLASSES = 1 + 2  # DDSM has two classes: benign and malignant
